...
/*  Autonomous from Position A 	*/
	...
	//turn
	tDrive(-60*direction,60*direction,1600); //timed driving distance: Left power, Right power, Time (ms)
	...
	// backup
	tDrive(-80,-80,1600); //himed driving distance: Left power, Right power, Time (ms)
}//end autoA
